...
class Ui_SettingsWizard(object):
    def setupUi(self, SettingsWizard):
        ...
        self.arkUserLabel = QtGui.QLabel(self.serverPage)
        self.arkUserLabel.setObjectName(_fromUtf8("arkUserLabel"))
        self.serverLayout.addWidget(self.arkUserLabel, 2, 0, 1, 2)
        self.arkUserEdit = QtGui.QLineEdit(self.serverPage)
        self.arkUserEdit.setObjectName(_fromUtf8("arkUserEdit"))
        self.serverLayout.addWidget(self.arkUserEdit, 2, 2, 1, 1)
        ...
        SettingsWizard.setTabOrder(self.arkUrlEdit, self.arkUserEdit)
        SettingsWizard.setTabOrder(self.arkUserEdit, self.arkPasswordEdit)
        SettingsWizard.setTabOrder(self.arkPasswordEdit, self.projectCodeCombo)
        SettingsWizard.setTabOrder(self.projectCodeCombo, self.projectNameEdit)
        SettingsWizard.setTabOrder(self.projectNameEdit, self.siteCodeEdit)
        SettingsWizard.setTabOrder(self.siteCodeEdit, self.locationEastingEdit)
        SettingsWizard.setTabOrder(self.locationEastingEdit, self.locationNorthingEdit)
        SettingsWizard.setTabOrder(self.locationNorthingEdit, self.userFullNameEdit)
        SettingsWizard.setTabOrder(self.userFullNameEdit, self.userInitialsEdit)

    def retranslateUi(self, SettingsWizard):
        SettingsWizard.setWindowTitle(_translate("SettingsWizard", "ARKspatial Project Wizard", None))
        self.serverPage.setTitle(_translate("SettingsWizard", "ARKspatial Project Wizard", None))
        self.serverPage.setSubTitle(_translate("SettingsWizard", "This wizard will walk you through setting up a new or existing ARKspatial project.", None))
        self.arkUrlLabel.setText(_translate("SettingsWizard", "ARK URL (optional):", None))
        self.arkUserLabel.setText(_translate("SettingsWizard", "User ID (optional):", None))
        self.arkUserEdit.setPlaceholderText(_translate("SettingsWizard", "dgarrod", None))
        ...
        self.siteCodeLabel.setText(_translate("SettingsWizard", "Site Code:", None))
        ...
        self.crsAuthidLabel.setText(_translate("SettingsWizard", "CRS:", None))
        self.siteRadiusLabel.setText(_translate("SettingsWizard", "Radius:", None))
        self.siteRadiusSpin.setSuffix(_translate("SettingsWizard", " km", None))
        self.projectNameEdit.setPlaceholderText(_translate("SettingsWizard", "Shuqba Cave, Wadi an-Natuf", None))
        self.siteCodeEdit.setPlaceholderText(_translate("SettingsWizard", "SHU28", None))
        self.locationNorthingEdit.setPlaceholderText(_translate("SettingsWizard", "Northing", None))
        self.projectLabel.setText(_translate("SettingsWizard", "You must enter at least a Project Code and Name. If no Site Code is entered, the Project Code is used instead. The Location will be used to create a site centre point and (optionally) a site radius.", None))
        ...
        self.userPageLabel.setText(_translate("SettingsWizard", "Enter your name and initials to be recorded as metadata on edits that you make.", None))
        ...
        self.projectFolderEdit.setPlaceholderText(_translate("SettingsWizard", "/Disk/Data/Projects/TST01/GIS", None))
        self.projectFileLabel.setText(_translate("SettingsWizard", "Project Filename:", None))
        self.confirmPageLabel.setText(_translate("SettingsWizard", "You can choose to save the project details in the currently open project, or to save the project in a new project file.\n"
"\n"
...
"", None))
        self.projectFolderLabel.setText(_translate("SettingsWizard", "Project Folder:", None))
        self.projectFileEdit.setPlaceholderText(_translate("SettingsWizard", "SHU28", None))
        self.projectFullPathLabel.setText(_translate("SettingsWizard", "Full Path:", None))
        self.label.setText(_translate("SettingsWizard", "Clear Project:", None))
