...
class Ui_EditWidget(object):
    def setupUi(self, EditWidget):
        ...
        self.snapPlanPointsTool = LayerSnappingToolButton(EditWidget)
        ...
        self.snapPlanLinesTool = LayerSnappingToolButton(EditWidget)
        ...
        self.snapBufferLinesTool = LayerSnappingToolButton(EditWidget)
        ...
        self.snapBufferPointsTool = LayerSnappingToolButton(EditWidget)
        ...
        self.snapBufferPolygonsTool = LayerSnappingToolButton(EditWidget)
        ...
        self.snapPlanPolygonsTool = LayerSnappingToolButton(EditWidget)
        ...
        self.snapBasePointsTool = LayerSnappingToolButton(EditWidget)
        ...
        self.snapBaseLinesTool = LayerSnappingToolButton(EditWidget)
        ...
        self.snapBasePolygonsTool = LayerSnappingToolButton(EditWidget)
...
from ..libarkqgis.snapping import LayerSnappingToolButton
