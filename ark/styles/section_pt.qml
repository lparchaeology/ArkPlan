...
<qgis version="2.14.10-Essen" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{e3bebbb7-d4af-48fc-b934-9aaafed669f5}">
      <rule filter="category = 'slv'" key="{ff45a655-d362-4db0-bfe2-86b6c2215948}" symbol="0" label="Section Level"/>
      <rule filter="category = 'txt'" key="{a385f730-3a9b-4677-a4a8-8163fc622a5c}" symbol="1" label="Text"/>
      <rule filter="category IS NULL or category NOT IN ('slv', 'txt')" key="{282b4f71-a81d-4ecf-b17e-d9829ab9c7cc}" symbol="2" label="UNKNOWN"/>
    </rules>
    <symbols>
    ...
    <rules>
      <rule description="Section Level" filter="category = 'slv'">
        <settings>
          ...
          <placement repeatDistanceUnit="1" placement="1" maxCurvedCharAngleIn="20" repeatDistance="0" distInMapUnits="0" labelOffsetInMapUnits="1" xOffset="0" distMapUnitScale="0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" repeatDistanceMapUnitScale="0,0,0,0,0,0" centroidWhole="0" priority="5" yOffset="0" offsetType="0" placementFlags="10" centroidInside="0" dist="0" angleOffset="0" maxCurvedCharAngleOut="-20" fitInPolygonOnly="0" quadOffset="1" labelOffsetMapUnitScale="0,0,0,0,0,0"/>
      ...
      <rule description="Text" filter="category = 'txt'">
        <settings>
          <text-style fontItalic="0" fontFamily="Gill Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="0,0,0,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="10" fieldName="comment" namedStyle="Regular" fontWordSpacing="0"/>
      ...
      <rule description="Name" filter="name IS NOT NULL and (category IS NULL or category NOT IN ('slv', 'txt'))">
        <settings>
