...
class Ui_SchematicWidget(object):
    def setupUi(self, SchematicWidget):
        ...
        SchematicWidget.resize(330, 775)
        ...
        self.schematicReportTool = QtGui.QToolButton(self.checkGroup)
        self.schematicReportTool.setEnabled(False)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ark/plan/schematicReport.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.schematicReportTool.setIcon(icon9)
        self.schematicReportTool.setObjectName(_fromUtf8("schematicReportTool"))
        self.horizontalLayout_3.addWidget(self.schematicReportTool)
        self.actionSettingsTool = ActionSettingsTool(self.checkGroup)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ark/settings.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSettingsTool.setIcon(icon10)
    ...
    def retranslateUi(self, SchematicWidget):
        ...
        self.schematicReportTool.setText(_translate("SchematicWidget", "...", None))
