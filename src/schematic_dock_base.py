...
class Ui_SchematicDockWidget(object):
    def setupUi(self, SchematicDockWidget):
        ...
        SchematicDockWidget.resize(326, 722)
        self.dockWidgetContents = QtGui.QWidget()
        self.dockWidgetContents.setObjectName(_fromUtf8("dockWidgetContents"))
        self.verticalLayout_2 = QtGui.QVBoxLayout(self.dockWidgetContents)
        self.verticalLayout_2.setObjectName(_fromUtf8("verticalLayout_2"))
        self.navToolbar = QtGui.QToolBar(self.dockWidgetContents)
        self.navToolbar.setIconSize(QtCore.QSize(22, 22))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 300, 605))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkPlan/plan/zoomToItem.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkPlan/plan/search.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label_3 = QtGui.QLabel(self.checkGroup)
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.gridLayout_5.addWidget(self.label_3, 4, 0, 1, 4)
        ...
        self.gridLayout_5.addWidget(self.editContextButton, 4, 6, 1, 2)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkPlan/plan/autoSchematic.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkPlan/plan/nodeTool.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, SchematicDockWidget):
        ...
        self.zoomContextTool.setToolTip(_translate("SchematicDockWidget", "<html><head/><body><p>Zoom to Context</p></body></html>", None))
        self.zoomContextTool.setText(_translate("SchematicDockWidget", "...", None))
        self.contextLabel.setText(_translate("SchematicDockWidget", "Check Context:", None))
        self.findContextTool.setToolTip(_translate("SchematicDockWidget", "<html><head/><body><p>Pan to Context</p></body></html>", None))
        self.findContextTool.setText(_translate("SchematicDockWidget", "...", None))
        self.contextSpin.setToolTip(_translate("SchematicDockWidget", "<html><head/><body><p>Enter Context to find</p></body></html>", None))
        self.label_3.setText(_translate("SchematicDockWidget", "Edit Context:", None))
        ...
        self.editContextButton.setText(_translate("SchematicDockWidget", "Edit", None))
        ...
        self.label_2.setText(_translate("SchematicDockWidget", "Copy and Edit Schematic:", None))
        ...
        self.label.setText(_translate("SchematicDockWidget", "Clone and Save Schematic:", None))
        self.zoomSourceTool.setToolTip(_translate("SchematicDockWidget", "<html><head/><body><p>Zoom to Context</p></body></html>", None))
        self.zoomSourceTool.setText(_translate("SchematicDockWidget", "...", None))
        self.findSourceTool.setToolTip(_translate("SchematicDockWidget", "<html><head/><body><p>Pan to Context</p></body></html>", None))
        self.findSourceTool.setText(_translate("SchematicDockWidget", "...", None))
        self.sourceContextSpin.setToolTip(_translate("SchematicDockWidget", "<html><head/><body><p>Enter Source Context to find</p></body></html>", None))
        self.sourceContextLabel.setText(_translate("SchematicDockWidget", "Source Context:", None))
        self.label_8.setText(_translate("SchematicDockWidget", "Edit Source Context:", None))
        self.editSourceButton.setText(_translate("SchematicDockWidget", "Edit", None))
        ...
        self.autoSchematicTool.setToolTip(_translate("SchematicDockWidget", "<html><head/><body><p>Auto Schematic</p></body></html>", None))
        self.autoSchematicTool.setText(_translate("SchematicDockWidget", "...", None))
        self.editPolygonsLabel.setText(_translate("SchematicDockWidget", "Edit Polygon Features:", None))
        self.editLinesLabel.setText(_translate("SchematicDockWidget", "Edit Line Features:", None))
        self.editLinesTool.setToolTip(_translate("SchematicDockWidget", "<html><head/><body><p>Edit Line Features</p></body></html>", None))
        self.editLinesTool.setText(_translate("SchematicDockWidget", "...", None))
        self.editPolygonsTool.setToolTip(_translate("SchematicDockWidget", "<html><head/><body><p>Edit Polygon Features</p></body></html>", None))
        self.editPolygonsTool.setText(_translate("SchematicDockWidget", "...", None))
