...
<qgis version="2.2.0-Valmiera" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="type" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="base" label="base"/>
      <category symbol="1" value="sec" label="sec"/>
      <category symbol="2" value="stn" label="stn"/>
      <category symbol="3" value="target" label="target"/>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="0" name="elevation"/>
