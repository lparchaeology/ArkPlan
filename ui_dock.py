...
class Ui_m_arkPlanDockWidget(object):
    def setupUi(self, m_arkPlanDockWidget):
        ...
        self.m_showPointsCheck = QtGui.QCheckBox(self.groupBox)
        self.m_showPointsCheck.setText(_fromUtf8(""))
        self.m_showPointsCheck.setChecked(True)
        self.m_showPointsCheck.setObjectName(_fromUtf8("m_showPointsCheck"))
        self.gridLayout_3.addWidget(self.m_showPointsCheck, 1, 1, 1, 1, QtCore.Qt.AlignHCenter)
    ...
    def retranslateUi(self, m_arkPlanDockWidget):
        ...
        self.m_showPointsCheck.setToolTip(_translate("m_arkPlanDockWidget", "Show existing levels", None))
        self.label_8.setText(_translate("m_arkPlanDockWidget", "Points:", None))
