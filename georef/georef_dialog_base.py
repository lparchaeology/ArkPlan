...
#
# Created: Mon Mar  2 14:34:33 2015
...
class Ui_GeorefDialogBase(object):
    def setupUi(self, GeorefDialogBase):
        ...
        self.m_gcpTable = QtGui.QTableWidget(self.layoutWidget)
        ...
        self.m_gridLabel1 = QtGui.QLabel(self.layoutWidget1)
        ...
        self.m_gridView1 = GeorefGraphicsView(self.layoutWidget1)
        ...
        self.m_fullPlanLabel = QtGui.QLabel(self.layoutWidget1)
        ...
        self.m_autoAllButton = QtGui.QPushButton(self.layoutWidget1)
        ...
        self.m_planView = GeorefGraphicsView(self.layoutWidget1)
        ...
        self.m_gridLabel2 = QtGui.QLabel(self.layoutWidget1)
        ...
        self.m_autoButton2 = QtGui.QPushButton(self.layoutWidget1)
        ...
        self.m_gridView2 = GeorefGraphicsView(self.layoutWidget1)
        ...
        self.m_gridLabel3 = QtGui.QLabel(self.layoutWidget1)
        ...
        self.m_autoButton3 = QtGui.QPushButton(self.layoutWidget1)
        ...
        self.m_gridView3 = GeorefGraphicsView(self.layoutWidget1)
        ...
        GeorefDialogBase.setTabOrder(self.m_gridView1, self.m_gridView2)
        GeorefDialogBase.setTabOrder(self.m_gridView2, self.m_gridView3)
        GeorefDialogBase.setTabOrder(self.m_gridView3, self.m_runCloseButton)
        ...
        GeorefDialogBase.setTabOrder(self.m_closeButton, self.m_autoButton1)
        GeorefDialogBase.setTabOrder(self.m_autoButton1, self.m_autoButton2)
        GeorefDialogBase.setTabOrder(self.m_autoButton2, self.m_autoButton3)
    ...
    def retranslateUi(self, GeorefDialogBase):
        ...
        item.setText(_translate("GeorefDialogBase", "GCP1", None))
        item = self.m_gcpTable.verticalHeaderItem(1)
        item.setText(_translate("GeorefDialogBase", "GCP2", None))
        item = self.m_gcpTable.verticalHeaderItem(2)
        item.setText(_translate("GeorefDialogBase", "GCP3", None))
        item = self.m_gcpTable.horizontalHeaderItem(0)
        item.setText(_translate("GeorefDialogBase", "Raw X", None))
        item = self.m_gcpTable.horizontalHeaderItem(1)
        item.setText(_translate("GeorefDialogBase", "Raw Y", None))
        item = self.m_gcpTable.horizontalHeaderItem(2)
        item.setText(_translate("GeorefDialogBase", "Grid X", None))
        item = self.m_gcpTable.horizontalHeaderItem(3)
        item.setText(_translate("GeorefDialogBase", "Grid Y", None))
        item = self.m_gcpTable.horizontalHeaderItem(4)
        item.setText(_translate("GeorefDialogBase", "Geo X", None))
        item = self.m_gcpTable.horizontalHeaderItem(5)
        item.setText(_translate("GeorefDialogBase", "Geo Y", None))
        __sortingEnabled = self.m_gcpTable.isSortingEnabled()
        self.m_gcpTable.setSortingEnabled(False)
        item = self.m_gcpTable.item(0, 0)
        item.setText(_translate("GeorefDialogBase", "0", None))
        ...
        self.m_gridLabel1.setText(_translate("GeorefDialogBase", "000 / 000 :", None))
        self.m_autoButton1.setText(_translate("GeorefDialogBase", "Auto", None))
        self.m_fullPlanLabel.setText(_translate("GeorefDialogBase", "Full Plan", None))
        self.m_autoAllButton.setText(_translate("GeorefDialogBase", "Auto All", None))
        self.m_gridLabel2.setText(_translate("GeorefDialogBase", "000 / 000 :", None))
        self.m_autoButton2.setText(_translate("GeorefDialogBase", "Auto", None))
        self.m_gridLabel3.setText(_translate("GeorefDialogBase", "000 / 000 :", None))
        self.m_autoButton3.setText(_translate("GeorefDialogBase", "Auto", None))
