...
class Ui_PreferencesDialogBase(object):
    def setupUi(self, PreferencesDialogBase):
        ...
        self.gridLayout.addWidget(self.serverWidget, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.preferencesWidget, 0, 0, 1, 1)
    ...
    def retranslateUi(self, PreferencesDialogBase):
        PreferencesDialogBase.setWindowTitle(_translate("PreferencesDialogBase", "Settings", None))
