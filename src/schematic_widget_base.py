...
class Ui_SchematicWidget(object):
    def setupUi(self, SchematicWidget):
        ...
        SchematicWidget.resize(302, 642)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 302, 600))
    ...
    def retranslateUi(self, SchematicWidget):
        ...
        self.label_3.setText(_translate("SchematicWidget", "Edit Context:", None))
