...
class Ui_GridDock(object):
    def setupUi(self, GridDock):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkPlan/grid/newGrid.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkPlan/grid/identifyCoordinates.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkPlan/grid/pastePoint.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkPlan/grid/panToSelected.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkPlan/grid/addPoint.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkPlan/grid/updateLayer.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkPlan/grid/translateFeature.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkPlan/grid/copyPoint.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.gridLabel = QtGui.QLabel(self.GridDockContents)
        self.gridLabel.setObjectName(_fromUtf8("gridLabel"))
        self.gridLayout.addWidget(self.gridLabel, 0, 0, 1, 1)
        self.gridCombo = QtGui.QComboBox(self.GridDockContents)
        ...
        self.panToAction.setIcon(icon3)
        ...
        GridDock.setTabOrder(self.createGridTool, self.identifyGridTool)
        GridDock.setTabOrder(self.identifyGridTool, self.pasteMapPointTool)
        GridDock.setTabOrder(self.pasteMapPointTool, self.panToTool)
        GridDock.setTabOrder(self.panToTool, self.addMapPointTool)
        GridDock.setTabOrder(self.addMapPointTool, self.updateLayerTool)
        GridDock.setTabOrder(self.updateLayerTool, self.translateFeaturesTool)
        GridDock.setTabOrder(self.translateFeaturesTool, self.gridCombo)
        GridDock.setTabOrder(self.gridCombo, self.mapEastingSpin)
        GridDock.setTabOrder(self.mapEastingSpin, self.mapNorthingSpin)
        GridDock.setTabOrder(self.mapNorthingSpin, self.copyMapPointTool)
        GridDock.setTabOrder(self.copyMapPointTool, self.localEastingSpin)
        GridDock.setTabOrder(self.localEastingSpin, self.localNorthingSpin)
        GridDock.setTabOrder(self.localNorthingSpin, self.copyLocalPointTool)
    ...
    def retranslateUi(self, GridDock):
        ...
        self.gridLabel.setText(_translate("GridDock", "Grid:", None))
