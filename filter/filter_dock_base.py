...
class Ui_FilterDock(object):
    def setupUi(self, FilterDock):
        ...
        self.filterSetCombo.addItem(_fromUtf8(""))
        self.gridLayout.addWidget(self.filterSetCombo, 0, 1, 1, 2)
        self.saveFilterSetButton = QtGui.QToolButton(self.FilterDockContents)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkPlan/document-save.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.saveFilterSetButton.setIcon(icon6)
        self.saveFilterSetButton.setObjectName(_fromUtf8("saveFilterSetButton"))
        self.gridLayout.addWidget(self.saveFilterSetButton, 0, 3, 1, 1)
