...
class Ui_FilterWidget(object):
    def setupUi(self, FilterWidget):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkPlan/list-add.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkPlan/mActionAdd.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
