...
<qgis version="2.14.10-Essen" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{ff60392a-ea76-4ae7-aaa6-550fd775a073}">
      <rule filter="&quot;category&quot; = 'fil'" key="{88a5081f-85e9-4903-b606-d3b07a7ccdff}" symbol="0" label="Fill"/>
      <rule filter="&quot;category&quot; = 'dep'" key="{db47aab0-dbfb-49c4-8af6-108c784017fb}" symbol="1" label="Deposit"/>
      <rule filter="ELSE" key="{1af9873e-2be6-4025-afd9-5ab9ed6bd302}" symbol="2" label="UNKNOWN"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="0.294118" clip_to_extent="1" type="fill" name="1">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="186,221,193,0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
  ...
  <labeling type="rule-based">
    <rules>
      <rule description="Deposit" filter="&quot;category&quot; = 'fil' or &quot;category&quot; = 'dep'">
        <settings>
          ...
          <placement repeatDistanceUnit="1" placement="0" maxCurvedCharAngleIn="20" repeatDistance="0" distInMapUnits="0" labelOffsetInMapUnits="1" xOffset="0" distMapUnitScale="0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" repeatDistanceMapUnitScale="0,0,0,0,0,0" centroidWhole="0" priority="5" yOffset="0" offsetType="0" placementFlags="10" centroidInside="1" dist="0" angleOffset="0" maxCurvedCharAngleOut="-20" fitInPolygonOnly="0" quadOffset="4" labelOffsetMapUnitScale="0,0,0,0,0,0"/>
