...
class Ui_PlanDockWidget(object):
    def setupUi(self, PlanDockWidget):
        ...
        self.gridLayout.addWidget(self.m_commentLabel, 1, 0, 1, 1)
        ...
        self.m_featureIdSpin.setMaximum(99999)
        ...
        PlanDockWidget.setTabOrder(self.m_siteEdit, self.m_commentEdit)
        PlanDockWidget.setTabOrder(self.m_commentEdit, self.m_createdByEdit)
        PlanDockWidget.setTabOrder(self.m_createdByEdit, self.m_sourceCodeCombo)
        ...
        PlanDockWidget.setTabOrder(self.m_sourceFileEdit, self.m_loadRawButton)
