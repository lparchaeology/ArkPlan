...
#
# Created: Wed May  6 12:17:06 2015
...
class Ui_PlanDockWidget(object):
    def setupUi(self, PlanDockWidget):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 363, 724))
        ...
        PlanDockWidget.setTabOrder(self.m_siteEdit, self.m_contextSpin)
        PlanDockWidget.setTabOrder(self.m_contextSpin, self.m_sourceEdit)
        ...
        PlanDockWidget.setTabOrder(self.m_commentEdit, self.m_extentTool)
        ...
        PlanDockWidget.setTabOrder(self.m_limitOfExcavationTool, self.m_verticalTruncationTool)
        PlanDockWidget.setTabOrder(self.m_verticalTruncationTool, self.m_truncationTool)
        PlanDockWidget.setTabOrder(self.m_truncationTool, self.m_breakOfSlopeTool)
        ...
        PlanDockWidget.setTabOrder(self.m_clearTool, self.m_snapLinesBufferTool)
