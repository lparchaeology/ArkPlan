...
from qgis.core import QgsMapLayer, QgsMapLayerRegistry, QgsProject, QgsVectorLayer, QgsWkbTypes
...
class LayerSnappingAction(LayerSnappingEnabledAction):
    ...
    def __init__(self, snapLayer, parent=None):
        ...
        if (isinstance(snapLayer, QgisInterface)
                or (isinstance(snapLayer, QgsVectorLayer) and snapLayer.geometryType() == QgsWkbTypes.PolygonGeometry)):
    ...
    def _refreshAction(self):
        ...
        if self._iface and self._avoidAction:
            ...
            isPolygon = (layer is not None and layer.type() ==
                         QgsMapLayer.VectorLayer and layer.geometryType() == QgsWkbTypes.PolygonGeometry)
