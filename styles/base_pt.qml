...
<qgis version="2.16.3" simplifyAlgorithm="0" minimumScale="100000" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="category" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      ...
      <category render="true" symbol="2" value="bhl" label="Borehole"/>
      <category render="true" symbol="3" value="lvl" label="lvl"/>
      <category render="true" symbol="4" value="tbm" label="TBM"/>
      <category render="true" symbol="5" value="tgt" label="Target"/>
    ...
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" name="4">
        <layer pass="0" class="FontMarker" locked="0">
          ...
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="joinstyle" v="miter"/>
          <prop k="offset" v="0.10000000000000001,1.60000000000000009"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="255,255,255,255"/>
          <prop k="outline_width" v="0"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;category&quot;" sortOrder="0">
    <columns>
      <column width="-1" hidden="0" type="field" name="ste_cd"/>
      <column width="-1" hidden="0" type="field" name="name"/>
      <column width="-1" hidden="0" type="field" name="category"/>
      <column width="-1" hidden="0" type="field" name="elevation"/>
      <column width="-1" hidden="0" type="field" name="source_cd"/>
      <column width="247" hidden="0" type="field" name="file"/>
      <column width="-1" hidden="0" type="field" name="comment"/>
      <column width="-1" hidden="0" type="field" name="cre_on"/>
      <column width="-1" hidden="0" type="field" name="cre_by"/>
      <column width="-1" hidden="0" type="field" name="map_x"/>
      <column width="-1" hidden="0" type="field" name="map_y"/>
      <column width="-1" hidden="0" type="field" name="local_x"/>
      <column width="-1" hidden="0" type="field" name="local_y"/>
