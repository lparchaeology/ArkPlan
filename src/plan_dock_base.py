...
class Ui_PlanDockWidget(object):
    def setupUi(self, PlanDockWidget):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 313, 376))
        ...
        self.gridLayout_4.addWidget(self.editPolygonsLabel, 5, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.editLinesTool, 4, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.editPolygonsTool, 5, 2, 1, 1)
        ...
        self.gridLayout_2.addLayout(self.sectionToolsLayout, 2, 0, 1, 4)
        ...
        self.sectionContextLabel = QtGui.QLabel(self.sectionsTab)
        self.sectionContextLabel.setObjectName(_fromUtf8("sectionContextLabel"))
        self.gridLayout_2.addWidget(self.sectionContextLabel, 1, 0, 1, 2)
        self.sectionContextSpin = QtGui.QSpinBox(self.sectionsTab)
        self.sectionContextSpin.setMaximum(9999)
        self.sectionContextSpin.setObjectName(_fromUtf8("sectionContextSpin"))
        self.gridLayout_2.addWidget(self.sectionContextSpin, 1, 2, 1, 2)
        ...
        self.sectionContextLabel.setBuddy(self.contextNumberSpin)
    ...
    def retranslateUi(self, PlanDockWidget):
        ...
        self.sectionContextLabel.setText(_translate("PlanDockWidget", "Context:", None))
        self.sectionContextSpin.setToolTip(_translate("PlanDockWidget", "Context Number", None))
