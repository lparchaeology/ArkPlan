...
<qgis version="2.14.10-Essen" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{a7abb5d6-beab-40c5-99b5-11454ae05cfc}">
      ...
      <rule filter="category = 'int'" key="{c82c2867-7a20-4a2d-a4e8-eb858c4c9299}" symbol="1" label="Interface"/>
      <rule filter="category = 'ueg'" key="{572b9d94-7b18-4154-9411-caff7f4d3c1a}" symbol="2" label="Uncertain Edge"/>
      <rule filter="category = 'loe'" key="{469ec37d-02da-4c37-8e7a-2b7bb0510614}" symbol="3" label="Limit of Excavation"/>
      <rule filter="category = 'trn'" key="{d4da9c75-9084-4c9c-ac79-372038128736}" symbol="4" label="Truncation"/>
      <rule filter="category = 'cut'" key="{b2a7b2ab-ee8b-4321-b935-25983b2499d2}" symbol="5" label="Cut in Section"/>
      <rule filter="category = 'tip'" key="{f5507640-faa0-4b39-b0e8-9c64107e7eaf}" symbol="6" label="Tipline in Section"/>
      <rule filter="category IS NULL or category NOT IN ('sln', 'int', 'ueg', 'loe', 'trn', 'cut', 'tip')" key="{75e4d065-e788-4b6d-8c7d-807baece5fb4}" symbol="7" label="UNKNOWN"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules>
      <rule description="Cut" filter=" &quot;category&quot; = 'cut'">
        <settings>
          <text-style fontItalic="0" fontFamily="Gill Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="0,0,0,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="10" fieldName="'[' || item_no || ']'" namedStyle="Regular" fontWordSpacing="0"/>
      ...
      <rule description="Section Line" filter="category = 'sln'">
        <settings>
          <text-style fontItalic="0" fontFamily="Gill Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="0,0,0,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="10" fieldName="'Section ' || item_no" namedStyle="Regular" fontWordSpacing="0"/>
          <text-format placeDirectionSymbol="0" multilineAlign="1" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
          <text-buffer bufferSize="1" bufferSizeMapUnitScale="0,0,0,0,0,0" bufferColor="255,255,255,255" bufferDraw="0" bufferBlendMode="0" bufferTransp="0" bufferSizeInMapUnits="0" bufferNoFill="0" bufferJoinStyle="64"/>
          <background shapeSizeUnits="1" shapeType="0" shapeSVGFile="" shapeOffsetX="0" shapeOffsetY="0" shapeBlendMode="0" shapeFillColor="255,255,255,255" shapeTransparency="0" shapeSizeMapUnitScale="0,0,0,0,0,0" shapeSizeType="0" shapeJoinStyle="64" shapeDraw="0" shapeBorderWidthUnits="1" shapeSizeX="0" shapeSizeY="0" shapeOffsetMapUnitScale="0,0,0,0,0,0" shapeRadiiX="0" shapeRadiiY="0" shapeOffsetUnits="1" shapeRotation="0" shapeBorderWidth="0" shapeBorderColor="128,128,128,255" shapeRotationType="0" shapeBorderWidthMapUnitScale="0,0,0,0,0,0" shapeRadiiMapUnitScale="0,0,0,0,0,0" shapeRadiiUnits="1"/>
          <shadow shadowOffsetMapUnitScale="0,0,0,0,0,0" shadowOffsetGlobal="1" shadowRadiusUnits="1" shadowTransparency="30" shadowColor="0,0,0,255" shadowUnder="0" shadowScale="100" shadowOffsetDist="1" shadowDraw="0" shadowOffsetAngle="135" shadowRadius="1.5" shadowRadiusMapUnitScale="0,0,0,0,0,0" shadowBlendMode="6" shadowRadiusAlphaOnly="0" shadowOffsetUnits="1"/>
      ...
      <rule description="Name" filter="name IS NOT NULL and (category IS NULL or category NOT IN  ('cut', 'sln'))">
        <settings>
          <text-style fontItalic="0" fontFamily="Gill Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="0,0,0,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="10" fieldName="name" namedStyle="Regular" fontWordSpacing="0"/>
