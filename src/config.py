...
class Config():
    ...
    featureCategories = [
        ...
        ['plan', 'cxt', 'ash', 'Ash',                     '', FeatureType.Polygon, False],
        ['plan', 'cxt', 'bne', 'Bone',                    '', FeatureType.Polygon, False],
        ...
        ['plan', 'cxt', 'coi', 'Coin',                    '', FeatureType.Polygon, False],
        ['plan', 'cxt', 'fli', 'Flint',                   '', FeatureType.Polygon, False],
        ['plan', 'cxt', 'gls', 'Glass',                   '', FeatureType.Polygon, False],
        ['plan', 'cxt', 'irn', 'Iron',                    '', FeatureType.Polygon, False],
        ...
        ['plan', 'cxt', 'wst', 'Wood Stain',              '', FeatureType.Polygon, False],
