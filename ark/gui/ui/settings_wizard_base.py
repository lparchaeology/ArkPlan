...
class Ui_SettingsWizard(object):
    def setupUi(self, SettingsWizard):
        ...
        self.projectFileLabel_2.setBuddy(self.projectFolderEdit)
        ...
        SettingsWizard.setTabOrder(self.siteCodesEdit, self.locationEastingEdit)
        ...
        SettingsWizard.setTabOrder(self.userInitialsEdit, self.projectFolderEdit)
        SettingsWizard.setTabOrder(self.projectFolderEdit, self.projectFolderButton)
        SettingsWizard.setTabOrder(self.projectFolderButton, self.projectFileEdit)
