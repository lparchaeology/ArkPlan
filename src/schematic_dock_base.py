...
class Ui_SchematicDockWidget(object):
    def setupUi(self, SchematicDockWidget):
        ...
        SchematicDockWidget.resize(349, 535)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 323, 441))
        ...
        self.gridLayout_5.addWidget(self.contextSpin, 0, 1, 1, 2)
        self.findContextTool = QtGui.QToolButton(self.checkGroup)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkPlan/plan/search.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.findContextTool.setIcon(icon)
        self.findContextTool.setObjectName(_fromUtf8("findContextTool"))
        self.gridLayout_5.addWidget(self.findContextTool, 0, 3, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.contextSchematicLabel, 2, 0, 1, 3)
        self.contextDataLabel = QtGui.QLabel(self.checkGroup)
        self.contextDataLabel.setObjectName(_fromUtf8("contextDataLabel"))
        self.gridLayout_5.addWidget(self.contextDataLabel, 1, 0, 1, 3)
        self.zoomContextTool = QtGui.QToolButton(self.checkGroup)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkPlan/plan/zoomToItem.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.zoomContextTool.setIcon(icon1)
        self.zoomContextTool.setObjectName(_fromUtf8("zoomContextTool"))
        self.gridLayout_5.addWidget(self.zoomContextTool, 0, 4, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.contextDataStatusLabel, 1, 4, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout_5.addWidget(self.contextSchematicStatusLabel, 2, 4, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.horizontalLayout.addWidget(self.copySourceButton)
        self.cloneSourceButton = QtGui.QPushButton(self.cloneGroup)
        self.cloneSourceButton.setObjectName(_fromUtf8("cloneSourceButton"))
        self.horizontalLayout.addWidget(self.cloneSourceButton)
        self.gridLayout_3.addLayout(self.horizontalLayout, 4, 1, 1, 4)
        ...
        self.gridLayout_3.addWidget(self.sourceSchematicLabel, 3, 0, 1, 4)
        self.sourceDataLabel = QtGui.QLabel(self.cloneGroup)
        self.sourceDataLabel.setObjectName(_fromUtf8("sourceDataLabel"))
        self.gridLayout_3.addWidget(self.sourceDataLabel, 2, 0, 1, 4)
