...
class Ui_TrenchWidget(object):
    def setupUi(self, TrenchWidget):
        ...
        self.gridLayout.addItem(spacerItem, 5, 2, 1, 5)
        ...
        self.gridLayout.addWidget(self.areaCombo, 1, 3, 1, 3)
        self.areaLabel = QtGui.QLabel(TrenchWidget)
        self.areaLabel.setObjectName(_fromUtf8("areaLabel"))
        self.gridLayout.addWidget(self.areaLabel, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.trenchLabel, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.areaSpin, 1, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.sampleAreaSpin, 3, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.widthSpin, 2, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.lengthSpin, 2, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.samplePercentSpin, 2, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.sampleLengthSpin, 3, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.sampleCountSpin, 3, 3, 1, 1)
