...
class Ui_GridDock(object):
    def setupUi(self, GridDock):
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkGrid/mActionPanToSelected.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.panToTool.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkGrid/mActionNewAttribute.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.updateLayerTool.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkGrid/mActionEditPaste.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pasteMapPointTool.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkGrid/mActionCapturePoint.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.addMapPointTool.setIcon(icon5)
        ...
        self.updateLayerAction.setIcon(icon3)
        ...
        self.pasteMapPointAction.setIcon(icon4)
