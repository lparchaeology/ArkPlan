...
class Ui_m_arkPlanDockWidget(object):
    def setupUi(self, m_arkPlanDockWidget):
        ...
        self.m_toolButtonGroup = QtGui.QButtonGroup(m_arkPlanDockWidget)
        ...
        self.gridLayout.addWidget(self.m_clearTool, 5, 2, 1, 1, QtCore.Qt.AlignHCenter)
    ...
    def retranslateUi(self, m_arkPlanDockWidget):
        ...
        self.m_clearTool.setText(_translate("m_arkPlanDockWidget", "clr", None))
...
from dock import QgsDockWidget
