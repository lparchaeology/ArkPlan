...
<qgis version="2.8.4-Wien" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="category" symbollevels="1" type="categorizedSymbol">
    <categories>
      ...
      <category render="true" symbol="11" value="sch" label="Schema"/>
      <category render="true" symbol="12" value="scs" label="Section Schema"/>
      <category render="true" symbol="13" value="sto" label="Stone"/>
      <category render="true" symbol="14" value="til" label="Tile"/>
      <category render="true" symbol="15" value="tim" label="Timber"/>
      <category render="true" symbol="16" value="wst" label="Wood Stain"/>
      <category render="true" symbol="17" value="" label="UNKNOWN"/>
    </categories>
    <symbols>
      ...
      <symbol alpha="0.4" type="fill" name="11">
      ...
      <symbol alpha="0.4" type="fill" name="12">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="CASE WHEN &quot;category&quot; = 'sch' or &quot;category&quot; = 'scs' THEN &quot;item_no&quot; ELSE ' ' END"/>
