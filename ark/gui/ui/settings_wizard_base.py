...
class Ui_SettingsWizard(object):
    def setupUi(self, SettingsWizard):
        ...
        self.projectLayout.addWidget(self.siteCodeEdit, 3, 2, 1, 3)
        ...
        self.radiusLabel = QtGui.QLabel(self.projectPage)
        self.radiusLabel.setObjectName(_fromUtf8("radiusLabel"))
        self.projectLayout.addWidget(self.radiusLabel, 5, 0, 1, 1)
        self.radiusSpin = QtGui.QDoubleSpinBox(self.projectPage)
        self.radiusSpin.setDecimals(1)
        self.radiusSpin.setMinimum(0.0)
        self.radiusSpin.setSingleStep(0.25)
        self.radiusSpin.setProperty("value", 1.0)
        self.radiusSpin.setObjectName(_fromUtf8("radiusSpin"))
        self.projectLayout.addWidget(self.radiusSpin, 5, 2, 1, 1)
        ...
        self.crsLabel.setBuddy(self.crsEdit)
        ...
        SettingsWizard.setTabOrder(self.locationNorthingEdit, self.crsEdit)
        SettingsWizard.setTabOrder(self.crsEdit, self.crsButton)
        SettingsWizard.setTabOrder(self.crsButton, self.userFullNameEdit)
    ...
    def retranslateUi(self, SettingsWizard):
        ...
        self.radiusLabel.setText(_translate("SettingsWizard", "Radius:", None))
        self.radiusSpin.setSuffix(_translate("SettingsWizard", " km", None))
