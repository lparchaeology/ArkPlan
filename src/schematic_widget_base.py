...
class Ui_SchematicWidget(object):
    def setupUi(self, SchematicWidget):
        ...
        SchematicWidget.resize(296, 688)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ark/filter/loadData.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.loadArkTool.setIcon(icon1)
        self.loadArkTool.setObjectName(_fromUtf8("loadArkTool"))
        self.horizontalLayout_3.addWidget(self.loadArkTool)
        self.openArkTool = QtGui.QToolButton(self.checkGroup)
        self.openArkTool.setEnabled(False)
        self.openArkTool.setText(_fromUtf8(""))
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ark/filter/web.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.openArkTool.setIcon(icon2)
        self.openArkTool.setObjectName(_fromUtf8("openArkTool"))
        self.horizontalLayout_3.addWidget(self.openArkTool)
