...
from PyQt4.QtCore import Qt, QFileInfo, QPoint, QPointF, QObject, SIGNAL
...
class ArkGeorefDialog(QtGui.QDialog, ark_georef_dialog_base.Ui_ArkGeorefDialogBase):
    ...
    def __init__(self, rawFile, gridReference, gridLayerId, gridX, gridY, parent=None):
        ...
        self.m_gridView1.centerOn(50, 50)
        ...
        self.m_gridView2.centerOn(50, self.rawPixmap.width() - 50)
        ...
        self.m_gridView3.centerOn(self.rawPixmap.width() - 50, self.rawPixmap.width() - 50)
