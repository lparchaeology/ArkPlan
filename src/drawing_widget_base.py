...
class Ui_DrawingWidget(object):
    def setupUi(self, DrawingWidget):
        ...
        self.autoSchematiclLabel = QtGui.QLabel(self.planPolygonGroup)
        self.autoSchematiclLabel.setObjectName(_fromUtf8("autoSchematiclLabel"))
        self.horizontalLayout.addWidget(self.autoSchematiclLabel)
        self.autoSchematicTool = QtGui.QToolButton(self.planPolygonGroup)
        icon = QtGui.QIcon()
        ...
        self.horizontalLayout.addWidget(self.autoSchematicTool)
        self.planPolygonLayout.addLayout(self.horizontalLayout, 0, 0, 1, 1)
        self.gridLayout.addWidget(self.planPolygonGroup, 6, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.planPointGroup, 4, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.planLineGroup, 5, 0, 1, 3)
        spacerItem = QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.gridLayout.addItem(spacerItem, 8, 0, 1, 3)
        self.contextLabel = QtGui.QLabel(self.planTab)
        self.contextLabel.setObjectName(_fromUtf8("contextLabel"))
        self.gridLayout.addWidget(self.contextLabel, 0, 0, 1, 1)
        self.contextSpin = QtGui.QSpinBox(self.planTab)
        self.contextSpin.setMaximum(99999)
        self.contextSpin.setObjectName(_fromUtf8("contextSpin"))
        self.gridLayout.addWidget(self.contextSpin, 0, 1, 1, 2)
        ...
        self.sectionLabel = QtGui.QLabel(self.sectionTab)
        ...
        self.gridLayout_2.addWidget(self.sectionPointGroup, 1, 0, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.sectionPolygonGroup, 3, 0, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.sectionLineGroup, 2, 0, 1, 3)
        ...
        self.sectionSpin = QtGui.QSpinBox(self.sectionTab)
        self.sectionSpin.setMaximum(99999)
        self.sectionSpin.setObjectName(_fromUtf8("sectionSpin"))
        self.gridLayout_2.addWidget(self.sectionSpin, 0, 1, 1, 2)
        ...
        self.autoSchematiclLabel.setBuddy(self.autoSchematicTool)
        self.contextLabel.setBuddy(self.contextSpin)
        self.sectionLabel.setBuddy(self.sectionSpin)

        self.retranslateUi(DrawingWidget)
        DrawingWidget.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(DrawingWidget)
        DrawingWidget.setTabOrder(self.contextSpin, self.autoSchematicTool)
        DrawingWidget.setTabOrder(self.autoSchematicTool, self.sectionSpin)
    ...
    def retranslateUi(self, DrawingWidget):
        ...
        self.contextLabel.setText(_translate("DrawingWidget", "Context:", None))
        self.contextSpin.setToolTip(_translate("DrawingWidget", "Source ID", None))
        ...
        self.sectionSpin.setToolTip(_translate("DrawingWidget", "Source ID", None))
