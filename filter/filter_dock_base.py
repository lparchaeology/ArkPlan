...
class Ui_FilterDock(object):
    def setupUi(self, FilterDock):
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkPlan/document-save.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkPlan/mActionDeleteSelected.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/ArkPlan/mActionCreateMemory.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
