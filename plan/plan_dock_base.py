...
class Ui_PlanDockWidget(object):
    ...
    def retranslateUi(self, PlanDockWidget):
        ...
        self.m_contextLabel.setText(_translate("PlanDockWidget", "Context:", None))
        self.m_contextSpin.setToolTip(_translate("PlanDockWidget", "Context Number", None))
        ...
        self.label_4.setText(_translate("PlanDockWidget", "Layers Visible:", None))
        ...
        self.m_showPolygonsCheck.setToolTip(_translate("PlanDockWidget", "Show existing polygons", None))
        self.m_showPointsCheck.setToolTip(_translate("PlanDockWidget", "Show existing levels", None))
        self.label_8.setText(_translate("PlanDockWidget", "Points:", None))
        self.m_showLinesCheck.setToolTip(_translate("PlanDockWidget", "Show existing lines", None))
