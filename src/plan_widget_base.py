...
class Ui_PlanWidget(object):
    def setupUi(self, PlanWidget):
        ...
        self.drawingScrollAreaContents.setGeometry(QtCore.QRect(0, 0, 392, 227))
        ...
        self.checkingScrollAreaContents.setGeometry(QtCore.QRect(0, 0, 392, 227))
        ...
        self.resetButton = QtGui.QPushButton(self.checkingTab)
        ...
        self.toolsScrollAreaContents.setGeometry(QtCore.QRect(0, 0, 392, 269))
        ...
        spacerItem3 = QtGui.QSpacerItem(20, 246, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
